...
export default function SummaryModal({ row, onClose }) {
  ...
  return (
    <Modal open={!!row} onClose={onClose} title="Budget Record Summary" size={showRecords ? "max-w-[1400px] w-[95vw]" : "max-w-2xl"}>
      <div className={showRecords ? "grid grid-cols-1 lg:grid-cols-2 gap-8" : "space-y-5"}>
