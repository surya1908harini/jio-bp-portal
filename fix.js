const fs = require('fs');
const filePath = 'C:/Users/M-tech/.gemini/antigravity/scratch/jio-bp-portal/frontend/src/pages/BudgetPage.jsx';
let lines = fs.readFileSync(filePath, 'utf8').split('\n');

const chunk =       {/* Header Banner & Executive Stat Cards */}
      <ModuleHeader
...
if (lines[409].includes('Pencil size={12}')) {
  lines.splice(409, 0, chunk);
  fs.writeFileSync(filePath, lines.join('\n'), 'utf8');
  console.log('Fixed successfully');
} else {
  console.log('Line 409 mismatch:', lines[409]);
}
